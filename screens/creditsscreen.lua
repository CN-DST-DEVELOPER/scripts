...
local CreditsScreen = Class(Screen, function(self)
    ...
    if not TheInput:ControllerAttached() then
        ...
        if PLATFORM ~= "PS4" and PLATFORM ~= "WIN32_RAIL" then
            ...
            self.FB_button:SetOnClick( function() VisitURL("https://facebook.com/kleientertainment") end )
            ...
            self.TWIT_button:SetOnClick( function() VisitURL("https://x.com/klei") end ) -- Formally twitter.com it now forwards to x.com
            ...
            self.THANKS_button:SetOnClick( function() VisitURL("https://www.dontstarvegame.com/Thank-You") end )
