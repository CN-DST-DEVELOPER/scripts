...
function DeployHelper:StartHelper(recipename, placerinst) -- NOTES(JBK): Parameter placerinst can be nil so onenablehelper and onstarthelper should check that if they want to use it.
