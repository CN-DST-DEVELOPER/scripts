...
local COLOUR_ENVELOPE_NAME_SMOKE = "torchfire_nautical_colourenvelope_smoke"
local SCALE_ENVELOPE_NAME_SMOKE = "torchfire_nautical_scaleenvelope_smoke"
local COLOUR_ENVELOPE_NAME = "torchfire_nautical_colourenvelope"
local SCALE_ENVELOPE_NAME = "torchfire_nautical_scaleenvelope"
local COLOUR_ENVELOPE_NAME_EMBER = "torchfire_nautical_colourenvelope_ember"
local SCALE_ENVELOPE_NAME_EMBER = "torchfire_nautical_scaleenvelope_ember"
...
local function emit_ember_fn(effect, sphere_emitter)
    local vx, vy, vz = .03 * UnitRand(), .02 + .06 * UnitRand(), .03 * UnitRand()
...
return MakeTorchFire("torchfire_nautical", assets, nil, common_postinit, master_postinit)
