...
{
    {
        ...
        scrapbook_specialinfo = "BOOK_TENTACLES",
        fx_under = "tentacles",
...

    {
        ...
        read_sanity = -TUNING.SANITY_HUGE,
        peruse_sanity = TUNING.SANITY_HUGE,
        scrapbook_specialinfo = "BOOK_BIRDS",
        fx = "fx_book_birds",
...

    {
        ...
        scrapbook_specialinfo = "BOOK_BRIMSTONE",
        fx_over = "lightning",
        fn = function(inst, reader)
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_SLEEP",
        fx = "fx_book_sleep",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = -TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_HORTICULTURE",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = -TUNING.SANITY_HUGE,
        scrapbook_specialinfo = "BOOK_HORTICULTURE_UPGRADED",
        fx_under = "plants_big",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = -TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_SILVICULTURE",
        fx_under = "roots",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = TUNING.SANITY_HUGE,
        scrapbook_specialinfo = "BOOK_FISH",
        fx = "fx_book_fish",
        fx_under = "fish",
        fn = function(inst, reader)
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = -TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_FIRE",
        fx = "fx_book_fire",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_WEB",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_TEMPERATURE",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_LIGHT",
        fx = "fx_book_light",
        deps = { "booklight" },
        fn = function(inst, reader)
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = TUNING.SANITY_HUGE,
        scrapbook_specialinfo = "BOOK_LIGHT_UPGRADED",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_RAIN",
        fx = "fx_book_rain",
...

    {
        ...
        read_sanity = -TUNING.SANITY_HUGE,
        peruse_sanity = -TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_MOON",
        fx = "fx_book_moon",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = -TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_BEES",
        fx = "fx_book_bees",
        deps =
        {
            "beeguard",
...

    {
        ...
        read_sanity = -TUNING.SANITY_LARGE,
        peruse_sanity = TUNING.SANITY_LARGE,
        scrapbook_specialinfo = "BOOK_RESEARCH_STATION",
...
local function MakeBook(def)
    ...
    local function fn()
        ...
        inst.scrapbook_specialinfo = def.scrapbook_specialinfo or nil
