...
local function on_ignite_over(inst)
    ...
    TheWorld:PushEvent("miniflare_detonated",{sourcept = inst:GetPosition(), pt=Vector3(fx, fy, fz), igniter = inst.flare_igniter})
...
return Prefab("miniflare", flare_fn, assets, prefabs),
        MakePlacer("miniflare_placer", "flare", "flare", "idle"),
