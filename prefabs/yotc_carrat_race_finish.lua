...
return Prefab("yotc_carrat_race_finish", fn, assets, prefabs),
    MakeDeployableKitItem("yotc_carrat_race_finish_item", "yotc_carrat_race_finish", "yotc_carrat_race_finish_item", "yotc_carrat_race_finish_item", "idle", {Asset("ANIM", "anim/yotc_carrat_race_finish_item.zip")}, {size = "med", scale = 0.77}, nil, {fuelvalue = TUNING.LARGE_FUEL}, carratrace_common.deployable_data),
