...
return Prefab("yotc_carrat_race_checkpoint", fn, assets, prefabs ),
       MakeDeployableKitItem("yotc_carrat_race_checkpoint_item", "yotc_carrat_race_checkpoint", "yotc_carrat_racekit_checkpoint", "yotc_carrat_racekit_checkpoint", "idle", {Asset("ANIM", "anim/yotc_carrat_race_checkpoint_item.zip")}, {size = "med", scale = 0.77}, nil, {fuelvalue = TUNING.LARGE_FUEL}, carratrace_common.deployable_data),
