local assets =
{
    Asset("DYNAMIC_ANIM", "anim/dynamic/lantern_insect.zip"),
    Asset("PKGREF", "anim/dynamic/lantern_insect.dyn"),
}
...
local function CreatePetal(petalemitter, variation, step)
    ...
    inst.AnimState:SetBank("lantern_insect_fx")
    inst.AnimState:SetBuild("lantern")
    inst.AnimState:OverrideItemSkinSymbol("glowflake", "lantern_insect", "glowflake", 0, "lantern")
...
return Prefab("lantern_insect_fx_held", heldfn, assets),
    Prefab("lantern_insect_fx_ground", groundfn, assets)
