...
local foodinfo =
{
    ...
    {food=FOODTYPE.VEGGIE,  health=2,     hunger=0,  sanity=1, treeornament=false, floater={"small", 0.93}, temperature = TUNING.HOT_FOOD_BONUS_TEMP, temperatureduration = TUNING.FOOD_TEMP_LONG, tags = {"fooddrink"}}, -- hot apple cider
    {food=FOODTYPE.GOODIES, health=1,     hunger=0,  sanity=2, treeornament=false, floater={"small", 0.55}, temperature = TUNING.HOT_FOOD_BONUS_TEMP, temperatureduration = TUNING.FOOD_TEMP_LONG, tags = {"fooddrink"}}, -- hot coco
    {food=FOODTYPE.MEAT,    health=0,     hunger=3,  sanity=0, treeornament=false, floater={"small", 0.45}, temperature = TUNING.COLD_FOOD_BONUS_TEMP, temperatureduration = TUNING.FOOD_TEMP_LONG, tags = {"fooddrink"}}, -- eggnog
}
