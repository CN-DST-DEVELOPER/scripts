...
local GROUND_TYPES =
{
	...
	WORLD_TILES.MOSAIC_BLUE,			WORLD_TILES.CARPET2,			WORLD_TILES.VAULT,			WORLD_TILES.VENT,
}
...
local function ConvertStaticLayoutToLayout(layoutsrc, additionalProps)
	...
	layout.ground_types = shallowcopy(GROUND_TYPES)
	layout.ground = {}
...
return {
	Get = ConvertStaticLayoutToLayout,
