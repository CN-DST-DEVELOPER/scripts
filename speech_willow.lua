...
--fallback to speech_wilson.lua     ANNOUNCE_BOOK_MOON_DAYTIME = "only_used_by_waxwell_and_wicker",
    ...
    ANNOUNCE_HEALINGSALVE_ACIDBUFF_DONE = "I think my Acid Repellent wore off, that's a kind of burn I DON'T like.",
	...
	DESCRIBE =
	{
        ...
        BOOK_FISH = "The only thing more boring than fishing is reading about fishing.",
        BOOK_FIRE = "You see something, you set it on fire. I don't need a book to teach me that!",
        BOOK_WEB = "Ew, who wants to read a book about spiders?",
        BOOK_TEMPERATURE = "Yaaaawwwn.",
        BOOK_LIGHT = "Wow, another book I'll never read!",
        BOOK_RAIN = "Ugh, I hate rain!",
        BOOK_MOON = "Another dumb book about whatever.",
        BOOK_BEES = "\"Rule one: don't set beehives on fire\"? This book's stupid!",
        
        BOOK_HORTICULTURE_UPGRADED = "Nice and thick, that should burn for a good while.",
        BOOK_RESEARCH_STATION = "How would everything even fit in there?",
        BOOK_LIGHT_UPGRADED = "Stop trying to get me to read!",
...
--fallback to speech_wilson.lua 			WEREBEAVER = "only_used_by_woodie", --woodie specific
        ...
        MUSHTREE_TALL =
        {
            ...
            BLOOM = "Ack! It stinks!",
            ACIDCOVERED = "I should check if it will still burn.",
        },
        MUSHTREE_MEDIUM =
        {
        ...
        {
            GENERIC = "That one got what it deserves.",
            ACIDCOVERED = "I should check if it will still burn.",
        },
        SPORE_TALL =
        {
...
--fallback to speech_wilson.lua 		DEVTOOL_NODEV = "I'm not strong enough to wield it.",
        ...
        SKELETON_NOTPLAYER = "Nasty! Who left their smelly old skeleton here?",
		...
		TREASURECHEST =
		{
            ...
            UPGRADED_STACKSIZE = "A big trunk for all my junk.",
		},
        ...
        WALL_SCRAP = "This looks like a fire hazard. Trust me.",
        WALL_SCRAP_ITEM = "This will be a fire hazard. Trust me.",
...
--fallback to speech_wilson.lua         WORTOX_SOUL = "only_used_by_wortox", --only wortox can inspect souls
        ...
        SHROOMBAIT = "I dare someone to try it.",
...
--fallback to speech_wilson.lua 			DEPLETED = "only_used_by_wanda",
        ...
        HEALINGSALVE_ACID = "Gross. It's mine.",

        BEESWAX_SPRAY = "The scariest part is how bad it smells.",
        WAXED_PLANT = "So it's just gonna stay that way forever?", -- Used for all waxed plants, from farm plants to trees.

        STORAGE_ROBOT = {
            GENERIC = "It frees up my time to burn things.",
