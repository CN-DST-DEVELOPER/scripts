...
local LunarThrall_Plant_Vine_Brain = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
end)

function LunarThrall_Plant_Vine_Brain:OnStart()
...
return LunarThrall_Plant_Vine_Brain