...
PREFAB_SKINS = {
	...
	tophat =
	{
		...
		"tophat_harlequin",
		"tophat_merchant",
		"tophat_minigolf_green",
		"tophat_minigolf_purple",
		"tophat_minigolf_red",
		"tophat_spiked",
		"tophat_western",
		"tophat_witch_pyre",
